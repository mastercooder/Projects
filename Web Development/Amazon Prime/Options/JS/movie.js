...
// -----------------Hero Section---------------------
const moAdd = document.querySelector('.mo-add');

function moaddRun(){
    moAdd.style.backgroundImage = 'url(/Icons/add2.png)';
    moAdd.style.backgroundColor = 'white';
}
function moaddStop(){
    moAdd.style.backgroundImage = 'url(/Icons/add.png)';
    moAdd.style.backgroundColor = '#35373d';
}
moAdd.addEventListener('mouseenter', moaddRun);
moAdd.addEventListener('mouseleave', moaddStop);


const moI = document.querySelector('.mo-i');
function moIRun(){
    moI.style.backgroundImage = 'url(/Icons/info2.png)';
    moI.style.backgroundColor = 'white';
}
function moIStop(){
    moI.style.backgroundImage = 'url(/Icons/info.png)';
    moI.style.backgroundColor = '#35373d';
}
moI.addEventListener('mouseenter', moIRun);
moI.addEventListener('mouseleave', moIStop);